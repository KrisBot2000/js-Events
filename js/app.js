...
var menuItems = ["Chicken McNuggets", "Shamrock Shake", "Large Fries"];
...
function redFace(){
	var redElem = document.getElementById("drink");
	redElem.style.fontSize = "20px";
	redElem.style.color = "red";
}
...
function showQuote(){
	pElem1 = document.getElementById("displayQuote");
	pElem1.innerHTML = myQuote;
}
